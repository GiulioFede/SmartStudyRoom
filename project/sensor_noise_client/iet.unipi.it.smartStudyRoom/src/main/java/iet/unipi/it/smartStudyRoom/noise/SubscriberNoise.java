...
public class SubscriberNoise implements MqttCallback{
	...
	public SubscriberNoise() throws MqttException{
	...
	public void messageArrived(String topic, MqttMessage message) throws Exception {
		...
		Timestamp timestampDato= new Timestamp(1000*(long)jsonNoise.getLong("timestamp"));
		...
		DatabaseConnection.addValueNoise(new Timestamp(1000*(long)jsonNoise.getLong("timestamp")),
